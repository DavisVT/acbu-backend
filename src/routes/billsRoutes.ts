...
import { getBillsCatalog, postBillsPay, postBillsRefund } from "../controllers/billsController";
...
router.get("/catalog", requireSegmentScope("bills:read", "bills:write"), getBillsCatalog);
